...
<template>
  ...
  <main class="flex flex-col w-full overflow-y-scroll mt-20 my-6">
    <section class="flex-col">
      <div class="flex flex-col">
        <hr class="h-2 my-2 bg-slate-100 border-none" />
      </div>
      <h1 class="font-normal text-2xl ml-6">A</h1>
      <div class="flex flex-col pt-3 px-6 gap-6">
        <div
          class="flex flex-col w-full mt-2 rounded-xl border border-solid border-slate-700"
        >
